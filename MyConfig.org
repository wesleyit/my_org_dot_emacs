...
(use-package ruby-mode
  ...
  :config
    (use-package rvm :init (rvm-use-default) :config (setq rvm-verbose nil))
    (use-package inf-ruby :ensure t :config (add-hook 'ruby-mode-hook 'inf-ruby-minor-mode))
    ...
    (use-package rubocop :ensure t :diminish rubocop-mode
